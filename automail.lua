getgenv().AutoMail = {
    ['Items'] = {
        ["Rainbow Gem"] = { Class = "Misc", Amount = 5000 },
	['Amethyst Gem'] = { Class = "Misc", Amount = 50000 },
        ['Onyx Gem'] = { Class = "Misc", Amount = 10 },
	['Sapphire Gem'] = { Class = "Misc", Amount = 50000 },
	['Ruby Gem'] = { Class = "Misc", Amount = 50000 },
	['Emerald Gem'] = { Class = "Misc", Amount = 50000 },
        ['Topaz Gem'] = { Class = "Misc", Amount = 200},
        ['Quartx Gem'] = { Class = "Misc", Amount = 1000 },	
