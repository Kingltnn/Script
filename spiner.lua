...
getgenv().HippoSniper = {
    ["Items"] = {
        ['Misc'] = {
            ['Secret Key'] = { Price =2500, pt = nil, sh = nil, tn = nil, Limit = 1000000, Terminal = true },
             ['Crystal Key'] = { Price =2500, pt = nil, sh = nil, tn = nil, Limit = 1000000, Terminal = true },
             ['Void Key'] = { Price =2500, pt = nil, sh = nil, tn = nil, Limit = 1000000, Terminal = true },
             ['Tech Key'] = { Price =2500, pt = nil, sh = nil, tn = nil, Limit = 1000000, Terminal = true },
             ['Hacker Key"'] = { Price =2500, pt = nil, sh = nil, tn = nil, Limit = 1000000, Terminal = true },
    ...
    ['All'] = {
        ['Pet'] = { 
            ['Huge'] = { Price = 5000000 },
            ['Titanic'] = { Price = 5000000 },
            ['Gargantuan'] = { Price = 5000000 },
        },
        ['Egg'] = {
            ['Egg'] = { Price = 5000 },
        },
    },
    ['Url'] = "https://discord.com/api/webhooks/1335792878298992651/MZHjfh5MBHvpvSgG_yK08HpPbPbutuwUWion3XxisCNrKu74oA673Wzx4Hutks9vk-5D",
}
